...
main() {
  ...
  bip32.BIP32 nodeFromSeed = bip32.BIP32.fromSeed(Uint8List.fromList(HEX.decode("000102030405060708090a0b0c0d0e0f")));
  ...
  var signature = nodeFromSeed.sign(Uint8List.fromList(message));
  print(signature);
  ...
  print(nodeFromSeed.verify(Uint8List.fromList(message), signature));
  // => true
}
